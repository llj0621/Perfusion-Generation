...
class LDMConfig:
    # Data
    latent_dir: str = ""
    raw_data_dir: str = r"E:\CTP\data\rest"
    metadata_csv: str = r"E:\CTP\data\timestamps_heartrate.csv"
    mask_dir: str = r"E:\CTP\data\heartchambers_seg_npy"
    num_frames: int = 25
    ...
    vae_ckpt: str = r"D:\Project\LiLJ\CTP_v2\checkpoints\ckpt_final.pt"
    vae_in_ch: int = 1
    vae_base_ch: int = 64
