"""Pre-encode all CTP data to VAE latents + downsampled masks for LDM training.

Key feature: mask-centered cropping instead of image-center cropping.

Usage:
    python LDM/encode_latents.py
    python LDM/encode_latents.py --data_dir E:/CTP/data/rest --out_dir E:/CTP/data/rest_latent_v3
"""
import os
import sys
import json
